...
abstract class BaseWidget(val context: Context, val id: Int, val stacked: Boolean) {
    ...
    private fun adjustRemoteViewsPadding(
        ...
        remoteViews.setViewPadding(R.id.buttonOverlay, 0, 0, 0, 0)
    }
